    ...
    <footer className="border-t border-gray-100 bg-white">
      <div className="mx-auto max-w-7xl px-6 py-12 sm:py-16">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="mt-3 text-sm text-gray-500">
              Your intelligent AI assistant for research, writing, coding, and
              more.
            </p>
            <div className="mt-4 flex gap-3">
              <a
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 text-gray-500 hover:text-gray-900 transition-colors"
                aria-label="Twitter"
              >
        ...
        <div className="mt-12 border-t border-gray-100 pt-8 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Arom AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
